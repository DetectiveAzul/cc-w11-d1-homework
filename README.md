...
#### Episode 2
*Solution* would be *Professor Plum* because we cannot modify *const murderer*, but
the code crash because of attempting this change.
...
#### Episode 4
*Solution* is *[Miss Scarlet, Professor Plum, Colonel Mustard]*
*Second log* is *Mrs. Peacock*
